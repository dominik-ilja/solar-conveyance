  ...
  return (
    <Container className="flex flex-col-reverse gap-8 py-8 text-white lg:grid lg:grid-cols-[2fr_3fr]">
      ...
      <div className="px-8 ">
        ...
        <div className="mb-8">
          <h1 className="p-4 mb-6 text-4xl text-center bg-blue-600">Launch Information</h1>
        ...
        <div className="mb-8">
          <h1 className="p-4 mb-6 text-4xl text-center bg-blue-600">Rocket Information</h1>
          <dl className="grid grid-cols-1 text-center sm:grid-cols-2 sm:text-left justify-items-center sm:justify-items-stretch gap-y-6">
            ...
            <dd>{ rocket ? <a className="text-blue-600 hover:text-blue-400" href={rocket.wikipedia}>{rocket.wikipedia}</a> : <Spinner /> }</dd>
          </dl>
        </div>
        <div className="mb-8">
          <h1 className="p-4 mb-6 text-4xl text-center bg-blue-600">Launch Pad Information</h1>
